    ...
    <ColorUniverseWrapper position={position}>
      ...
      <Billboard>
        <Text
          ...
          textAlign="center"
          lineHeight={0.8}
          maxWidth={titleFontSize * sectionWidth}
        >
          {title}
        </Text>
        <Text
          ...
          position={[0, -titleFontSize - 0.1, 2]}
          textAlign="center"
          maxWidth={titleFontSize * (sectionWidth - 1)}
        >
          {description}
        </Text>
        <Text
          color="white"
          fontSize={titleFontSize * 0.2}
          position={[0, -titleFontSize * 2 - 0.1, 2]}
          textAlign="center"
          maxWidth={titleFontSize * (sectionWidth - 1)}
          fillOpacity={0.7}
        >
